export interface OsmoseParameter {
  ...
  readonly group: 'macro' | 'gain' | 'effects' | 'performance' | 'equalizer' | 'dynamics'
}
...
export const osmoseParameters: readonly OsmoseParameter[] = [
  ...
  { name: 'Postgain', controlChange: 18, group: 'gain' }, { name: 'Global FX parameter 1', controlChange: 20, group: 'effects' },
  ...
  { name: 'Pregain', controlChange: 26, group: 'gain' }, { name: 'Sustain', controlChange: 64, group: 'performance' },
  ...
  { name: 'EQ mix', controlChange: 85, group: 'equalizer' }, { name: 'Compressor mix', controlChange: 93, group: 'dynamics' },
]
